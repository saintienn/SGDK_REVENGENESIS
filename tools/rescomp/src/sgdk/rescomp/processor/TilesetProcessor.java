...
public class TilesetProcessor implements Processor
{
    ...
    public Resource execute(String[] fields) throws Exception
    {
        if (fields.length < 3)
        {
            ...
            System.out.println("                    3 / LITE / LITEPACK = custom litepack compression (average compression ratio but fast)");
			System.out.println("                    4 / BLAST / MEGAPACK = custom megapack compression (good compression ratio but fast)");
